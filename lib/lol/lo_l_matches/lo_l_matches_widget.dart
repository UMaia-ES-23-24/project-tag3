...
import 'lo_l_matches_model.dart';
export 'lo_l_matches_model.dart';

class LoLMatchesWidget extends StatefulWidget {
  const LoLMatchesWidget({
    super.key,
    int? idLeague,
  ...
  @override
  State<LoLMatchesWidget> createState() => _LoLMatchesWidgetState();
}

class _LoLMatchesWidgetState extends State<LoLMatchesWidget>
    with TickerProviderStateMixin {
  late LoLMatchesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LoLMatchesModel());
