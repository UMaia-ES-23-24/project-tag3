...
import 'foot_solo_player_model.dart';
export 'foot_solo_player_model.dart';

class FootSoloPlayerWidget extends StatefulWidget {
  const FootSoloPlayerWidget({
    super.key,
    required this.jogador,
  });

  final dynamic jogador;

  @override
  State<FootSoloPlayerWidget> createState() => _FootSoloPlayerWidgetState();
}

class _FootSoloPlayerWidgetState extends State<FootSoloPlayerWidget>
    with TickerProviderStateMixin {
  late FootSoloPlayerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FootSoloPlayerModel());
