  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      if ((_model.apiResultmov?.succeeded ?? true)) {
        setState(() {
          FFAppState().listaLolzinho =
              FFAppState().listaLolzinho.toList().cast<dynamic>();
        });
      }
    });
  }
            ...
            Padding(
              ...
              child: InkWell(
                ...
                onLongPress: () async {
                  ...
                  setState(() {
                    FFAppState().addToFavorites('CBLOL');
                  });
                },
                child: Container(
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                          ...
                          child: Row(
                            ...
                            children: [
                              ClipRRect(
                                borderRadius: BorderRadius.circular(12.0),
                                child: Image.asset(
                                  'assets/images/CBLOL_2021_Logo.png',
                                  width: 65.0,
                                  height: 60.0,
                                  fit: BoxFit.fill,
                                ),
                        ...
                        if (FFAppState().Favorites.contains('CBLOL') == true)
                          const Icon(
                            Icons.star,
