            ...
            children: [
                            ...
                            child: Stack(
                              ...
                              children: [
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color:
                                        FlutterFlowTheme.of(context).allWhite,
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    if (FFAppState().hasFavorites == false)
                      Padding(
                        padding: const EdgeInsetsDirectional.fromSTEB(
                            24.0, 30.0, 24.0, 10.0),
                        child: Container(
                    ...
                    if (FFAppState().hasFavorites == true)
                      Expanded(
                        child: Builder(
                          builder: (context) {
                            final favoritos = FFAppState().Favorites.toList();
